...
function normalizeEndpoint(endpoint = {}, input = {}) {
  ...
  return {
    ...
    connectBaseUrl: clean(source.connectBaseUrl || source.connectPublicBaseUrl || input.connectBaseUrl || input.connectPublicBaseUrl),
    setupUrl: clean(source.setupUrl || source.publicSetupUrl || input.setupUrl || input.publicSetupUrl),
    publicBaseUrl: clean(source.publicBaseUrl || source.publicUrl || source.publicAppBaseUrl || input.publicBaseUrl || input.publicUrl || input.publicAppBaseUrl),
