    ...
    },
    {
      ...
      parameters: {
        ...
        properties: {
          ...
          oauthApp: { type: "string", description: "Named Google OAuth app profile, or empty for the deployment default. Use a non-default profile only when explicitly requested by the user." },
        ...
        required: ["provider", "account", "shop", "accountId", "alias", "useMode", "oauthApp", "setAsMain", "setAsThreadDefault"],
        additionalProperties: false,
      },
      strict: true,
    },
