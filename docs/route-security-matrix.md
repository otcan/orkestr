...
| Tenant VM registry and provisioning | `GET/POST/PATCH/DELETE /api/tenant-vms`, `POST /api/tenant-vms/:id/provision` | Admin only | tenant VM registry/provisioning controller and control-plane guard |
