...
export function commercialHomePage(): PublicPage {
  ...
  <section class="ugly-problem" aria-labelledby="ugly-title">
    ...
    <div class="problem-quotes" aria-label="Example project starting points"><blockquote>“Our internal system is 15 years old and nobody wants to touch it.”</blockquote><blockquote>“We need online ordering but do not know what stack to use.”</blockquote><blockquote>“Someone copies every customer email into three systems.”</blockquote><blockquote>“We check 40 websites every morning.”</blockquote><blockquote>“We keep missing tenders because nobody has time to search.”</blockquote></div>
  </section>
  ...
  <section class="section approval-section" aria-labelledby="approval-title">
    ...
    <article class="approval-card" aria-label="Illustrative migration review"><div class="approval-card-head"><span>REVIEW REQUIRED</span><strong>Record mapping conflict</strong></div><dl class="approval-values"><div><dt>Record</dt><dd>#10452</dd></div><div><dt>Legacy owner</dt><dd>Missing</dd></div><div class="difference"><dt>Action</dt><dd>Review</dd></div></dl><ul><li>Source record preserved <span>✓</span></li><li>Related activity checked <span>✓</span></li><li>Migration rule attached <span>✓</span></li></ul><p class="approval-label">DECISION</p><div class="approval-actions"><button type="button" disabled>Approve mapping</button><button type="button" disabled>Review record</button></div><small>Public-safe illustration. Controls are inactive.</small></article>
  </section>
