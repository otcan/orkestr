...
const localizedHomeCopy: Record<"de" | "tr", LocalizedHomeCopy> = {
  de: {
    ...
    proof: { label: "AUF ORKESTR AUFGEBAUT", heading: "Mehr als eine Software-Übergabe.", paragraphs: ["Wenn ein System geplante Abläufe, Browserausführung, dauerhafte Aufgaben, menschliche Entscheidungen oder Wiederherstellung benötigt, hält die Orkestr-Betriebsebene diese Arbeit sichtbar und kontrollierbar.", "Nicht jedes Projekt braucht jede Funktion. Wir verwenden die einfachste Architektur, die zur Anforderung passt."], points: ["APIs, wenn verfügbar", "Kontrollierte Browserausführung, wenn sinnvoll", "Explizite Zugriffe und menschliche Prüfung, wo erforderlich"], link: "So wird der Zugriff kontrolliert" },
    final: { label: "MIT 20 MINUTEN BEGINNEN", heading: "Erzählen Sie uns, was besser funktionieren soll.", text: "Ein kurzes Gespräch reicht aus, um einen glaubwürdigen nächsten Schritt zu bestimmen. Kein technisches Lastenheft und keine Plattformmigration erforderlich.", book: "Projektgespräch buchen", write: "Oder in 60 Sekunden beschreiben" },
  },
  tr: {
    ...
    eyebrow: "İŞ SİSTEMLERİ · GELİŞTİRİLİR & İŞLETİLİR",
    ...
    trust: ["Sorunla başlayın", "Geliştirmeden önce net teklif", "Yayından sonra yönetilen işletim"],
    ...
    services: {
      ...
      items: [
        { title: "Yeni sistemler geliştirin", copy: "İşletmenin gerçek çalışma biçimine göre web sitesi, e-ticaret, portal, şirket içi araç veya müşteri uygulaması geliştirin.", examples: "Web siteleri · E-ticaret · Portallar · Uygulamalar", id: "websites-commerce" },
        { title: "Mevcut sistemleri modernleştirin", copy: "Eski bir uygulamayı yenileyin, aksayan bir süreci yeniden tasarlayın veya artık ihtiyacı karşılamayan yazılımdan güvenli biçimde çıkın.", examples: "Eski sistemler · İç yazılımlar · Veri geçişi", id: "business-systems" },
        { title: "İşi ve veriyi otomatikleştirin", copy: "Bilgiyi toplayıp izleyin, yazılımları bağlayın ve tekrarlanan manuel işleri kontrollü bir iş sürecine dönüştürün.", examples: "Veri izleme · Entegrasyon · Yapay zekâ iş akışları", id: "automation" },
      ],
    },
    examples: {
      label: "GERÇEK BİR SORUNLA BAŞLAYIN", heading: "Teknik şartnameyle gelmeniz gerekmez.", link: "Daha fazla proje örneği",
      items: [["GELİŞTİR", "“Müşterilerin sipariş verebileceği yeni bir B2B web sitesine ihtiyacımız var.”", "Web sitesi, müşteri hesabı, sipariş süreci, yönetim ve yayın."], ["MODERNLEŞTİR", "“Şirket içi sistemimiz eski, kırılgan ve artık işimize uymuyor.”", "İnceleme, yenileme tasarımı, geçiş planı ve kontrollü devreye alma."], ["OTOMATİKLEŞTİR", "“Ekibimiz sürekli web sitelerini arıyor ve sonuçları elle aktarıyor.”", "Yetkili veri toplama, yapılandırma, inceleme, bildirim ve işletim."]],
    },
    process: { label: "NASIL ÇALIŞIYORUZ", heading: "Görüşmeden çalışan sisteme.", intro: "Her proje görünür bir karar süreciyle ilerler. Geliştirme başlamadan önce ne yapılacağını bilirsiniz.", items: [["Konuş", "Hedefi, mevcut sorunu ve kimleri etkilediğini anlatın."], ["Tanımla", "Kullanıcıları, kapsamı, mimariyi, riskleri ve işletim modelini netleştirelim."], ["Geliştir", "Kararlaştırılan sistemi uygulayalım, test edelim ve devreye alalım."], ["İşlet", "Yayından sonra sistemi izleyelim, bakımını yapalım, destekleyelim ve geliştirelim."]] },
    proof: { label: "ORKESTR ÜZERİNDE ÇALIŞIR", heading: "Teslim edip gitmekten fazlası.", paragraphs: ["Bir sistem zamanlanmış işler, tarayıcı işlemleri, kalıcı görevler, insan kararları veya hata sonrası devam kabiliyeti gerektiriyorsa Orkestr işletim katmanı bu çalışmayı görünür ve kontrollü tutar.", "Her proje her özelliğe ihtiyaç duymaz. İhtiyaca uyan en sade mimariyi kullanırız."], points: ["Mevcut olduğunda API'ler", "Uygun olduğunda kontrollü tarayıcı işlemleri", "Gerektiğinde açık erişim sınırları ve insan incelemesi"], link: "Erişimin nasıl kontrol edildiğini görün" },
    final: { label: "20 DAKİKAYLA BAŞLAYIN", heading: "Neyin daha iyi çalışması gerektiğini anlatın.", text: "Kısa bir görüşme, gerçekçi bir sonraki adım olup olmadığını belirlemek için yeterlidir. Teknik şartname veya platform geçişi gerekmez.", book: "Proje görüşmesi planla", write: "Ya da 60 saniyede yazın" },
  },
};
