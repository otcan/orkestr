export function googleWorkspaceReviewActionsPageHtml({ workspaceHref = "/" }: { workspaceHref?: string } = {}): string {
  return `<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
<body>
  <main>
    ...
    <p><a class="button secondary" href="${workspaceHref}">Back to Orkestr workspace</a></p>
