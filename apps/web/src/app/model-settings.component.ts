...
@Component({
  ...
  `,
  styles: [`section { display: flex; flex-wrap: wrap; gap: 12px; align-items: end; margin: 16px 0; } label { display: grid; gap: 6px; flex: 1; min-width: 0; } select { width: 100%; min-width: 120px; padding: 8px; } select, button { min-height: 44px; } p { flex-basis: 100%; margin: 0; }`],
})
