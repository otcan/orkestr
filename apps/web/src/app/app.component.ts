...
export class AppComponent implements OnInit, OnDestroy, AfterViewChecked {
  ...
  private canonicalizeInstanceRoute(): boolean {
    ...
    else if (parts[0] === "apps" || (parts[0] === "ng" && parts[1] === "apps")) suffix = "apps";
  ...
  private panelFromPath(): Panel {
    ...
    if (parts[0] === "apps" || (parts[0] === "ng" && parts[1] === "apps")) return "instanceApps";
  ...
  private normalizeLegacyRoutePath(): void {
    ...
    if (parts[0] === "ng" && parts[1] === "apps") {
      globalThis.history?.replaceState({}, "", this.instancePath("/apps"));
      return;
    }
  ...
  private pathForPanel(id: string, panel: Panel): string {
    ...
    if (panel === "instanceApps") return this.instancePath("/apps");
  ...
  private updateDocumentTitle(): void {
    ...
    if (this.activePanel === "instanceApps") {
      globalThis.document.title = "Apps · Orkestr";
      return;
    }
